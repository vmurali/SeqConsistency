...
Variable getInfo: forall r1 r2 (t: CacheTrans r1 r2), option (Addr * Proc * Data * Desc * Data).
  ...
  CoInductive CacheTransStream: CacheState -> Set :=
    | SCons: forall r r', CacheTrans r r' -> CacheTransStream r' -> CacheTransStream r.

  Fixpoint getNStateSpec' n r (ls: CacheTransStream r) :=
    match ls with
  ...
  Fixpoint getNState n r (ls: CacheTransStream r) :=
    match ls with
