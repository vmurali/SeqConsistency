Require Import SeqConsistency.Useful SeqConsistency.DataTypes List Coq.Logic.FunctionalExtensionality SeqConsistency.Transitions SeqConsistency.StoreAtomicity.
  ...
  Section PerProc.
    ...
    Theorem bigCondition:
      forall a1 a1' (ta1: Spec a1 a1')
        ...
        {rec | getCorrectIo (convertSpecToCorrect ta1) =
               getImIo (tb2 rec) /\
