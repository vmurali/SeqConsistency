...
Section PerProc.
  ...
  Inductive AtomicTrans: Mem -> Mem -> Set :=
  | AReq: forall m a w d, AtomicTrans m match w with
                                          | Ld => m
                                          | St => fun a' =>
                                                    if decAddr a a'
                                                    then d
  ...
  | Idle m: AtomicTrans m m.

  Definition AtomicList := TransList AtomicTrans initData.
